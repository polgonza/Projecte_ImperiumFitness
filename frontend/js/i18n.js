...
const I18n = (() => {
  ...
  const TRADUCCIONS = {
    ...
    ca: {
      ...
      "blog.catEntrenament": "Entrenament",
      "blog.catNutricioArt": "Nutrició",
      "blog.catBenestar":    "Benestar",
      "blog.art1titol": "5 exercicis per maximitzar el teu entrenament de força",
      "blog.art1desc":  "Descobreix les tècniques que utilitzen els atletes professionals per augmentar la seva força en menys temps.",
      "blog.art2titol": "Alimentació pre i post entrenament: la guia definitiva",
      "blog.art2desc":  "Aprèn quan i què menjar per rendir al màxim i recuperar-te més ràpidament després de cada sessió.",
      "blog.art3titol": "La importància de la recuperació activa en el teu pla d'entrenament",
      "blog.art3desc":  "El descans no és no fer res. La recuperació activa pot marcar la diferència entre estancar-se i progressar.",
      "blog.llegirMes": "Llegir més →",
      ...
      "checkoutTarifa.titol":          "Contractar Pla",
      "checkoutTarifa.subtitol":       "Introdueix les teves dades de pagament per activar la subscripció",
      "checkoutTarifa.dadesFacturacio":"Dades de facturació",
      "checkoutTarifa.activar":        "🔒 Activar subscripció",
      "checkoutTarifa.segur":          "Pagament simulat — les teves dades no s'emmagatzemen",
      "checkoutTarifa.resum":          "La teva subscripció",
      "checkoutTarifa.periodicitat":   "Periodicitat",
      "checkoutTarifa.mensual":        "Mensual",
      "checkoutTarifa.propera":        "Propera renovació",
      "checkoutTarifa.tornar":         "← Tornar a les tarifes",
      "checkoutTarifa.exitTitol":      "Subscripció activada!",
      "checkoutTarifa.exitDesc":       "El teu pla ha estat activat correctament. Ja pots reservar classes i gaudir de tots els avantatges.",
      "checkoutTarifa.reservarClasse": "Reservar una classe",
      "checkoutTarifa.versPerfil":     "Veure el meu perfil",
      "checkoutTarifa.err16digits":    "Introdueix 16 dígits",
      "checkoutTarifa.errFormat":      "Format MM/AA",
      "checkoutTarifa.err3digits":     "3 dígits",  
    ...
    en: {
      ...
      "blog.catEntrenament": "Training",
      "blog.catNutricioArt": "Nutrition",
      "blog.catBenestar":    "Wellness",
      "blog.art1titol": "5 exercises to maximise your strength training",
      "blog.art1desc":  "Discover the techniques professional athletes use to increase their strength in less time.",
      "blog.art2titol": "Pre and post-workout nutrition: the definitive guide",
      "blog.art2desc":  "Learn when and what to eat to perform at your best and recover faster after every session.",
      "blog.art3titol": "The importance of active recovery in your training plan",
      "blog.art3desc":  "Rest is not doing nothing. Active recovery can make the difference between stagnating and progressing.",
      "blog.llegirMes": "Read more →",
      ...
      "checkoutTarifa.titol":          "Subscribe to Plan",
      "checkoutTarifa.subtitol":       "Enter your payment details to activate your subscription",
      "checkoutTarifa.dadesFacturacio":"Billing details",
      "checkoutTarifa.activar":        "🔒 Activate subscription",
      "checkoutTarifa.segur":          "Simulated payment — your data is not stored",
      "checkoutTarifa.resum":          "Your subscription",
      "checkoutTarifa.periodicitat":   "Billing period",
      "checkoutTarifa.mensual":        "Monthly",
      "checkoutTarifa.propera":        "Next renewal",
      "checkoutTarifa.tornar":         "← Back to plans",
      "checkoutTarifa.exitTitol":      "Subscription activated!",
      "checkoutTarifa.exitDesc":       "Your plan has been activated successfully. You can now book classes and enjoy all the benefits.",
      "checkoutTarifa.reservarClasse": "Book a class",
      "checkoutTarifa.versPerfil":     "View my profile",
      "checkoutTarifa.err16digits":    "Enter 16 digits",
      "checkoutTarifa.errFormat":      "Format MM/YY",
      "checkoutTarifa.err3digits":     "3 digits",
